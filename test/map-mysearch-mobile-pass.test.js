...
test('PriorityBoard extracts a shared TierItemsList so desktop and the mobile Sheet never drift apart', () => {
  assert.match(priorityBoard, /function TierItemsList\(\{ tier, items, activeItem, setActiveItem, setTier, priorities, patch, setSchoolsNote, onItemDragStart, onItemDragEnd, cueKey \}\)/);
