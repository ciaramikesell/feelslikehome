...
export default async function ArchivePage() {
  ...
  return (
    <DecisionNav active="archive" hasFavorites={hasFavorites} hasArchived={hasArchived}>
      ...
      <HomesBoard mode="archive" userId={user.id} searchId={search.id} initialHomes={homesWithSignal} initialPriorities={normalizePriorities(priorities)} sharedFactAwareness={sharedFactAwareness} />
    </DecisionNav>
  );
}
