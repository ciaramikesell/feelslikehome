...
export default async function RealtorHomePage({ params }) {
  ...
  return <HomeDetail home={participantHome} priorities={priorities} userId={user.id} searchId={searchId} coBuyerPerspective={coBuyerPerspective} readOnly backHref={`/people/${searchId}`} isCollaborative={context.people.length > 1} />;
}
