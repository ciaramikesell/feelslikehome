  ...
  return (
    <div className="hh-modal-backdrop" onMouseDown={(event) => event.target === event.currentTarget && onCancel()}>
      <div className="hh-modal hh-corner" style={{ maxWidth: 440, padding: 26 }}>
        ...
        <textarea className="hh-textarea" style={{ minHeight: 70, width: '100%' }} value={reason} onChange={(event) => setReason(event.target.value)} placeholder="e.g. Busy road, no basement, taxes too high" />
