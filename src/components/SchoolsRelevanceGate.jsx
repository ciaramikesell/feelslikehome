      ...
      {relevance === 'yes' && (
        <div style={{ marginTop: 10 }}>
          ...
          <p style={{ fontSize: 11.5, color: 'var(--ink-soft)', margin: '0 0 6px' }}>
            A specific school, district, school area, or zone description. Optional and entirely yours.
          </p>
          <input
            className="hh-input"
            value={note}
            onChange={(e) => setNote(e.target.value)}
            placeholder="e.g. Adams High School; Rochester Community Schools; preferred school zone"
            style={{ width: '100%' }}
          />
        </div>
      )}
