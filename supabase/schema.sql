...
-- 2026-09-16 Realtor-started client searches
...
grant select (id, client_name, invited_email, status, draft_priorities, created_at, updated_at),
  update (client_name, draft_priorities, updated_at) on public.prospective_searches to authenticated;
