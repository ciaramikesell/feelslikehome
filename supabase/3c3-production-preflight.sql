...
with required(table_name, column_name) as (values
  ...
  ('homes','basement_notes'),('homes','schools_notes'),('homes','condition_notes'),('homes','property_type'),
  ('homes','available_on'),('homes','pets_allowed'),('homes','utilities_included'),
  ('homes','in_unit_laundry'),
